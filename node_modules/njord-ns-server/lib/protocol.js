...
var serializers = {
        'UInt32BE': {
                encoder: function(v) {
                        var b = new Buffer.allocUnsafe(4);
                        b.writeUInt32BE(v, 0);
                        return b;
                },
        ...
        'UInt16BE': {
                encoder: function(v) {
                        var b = new Buffer.allocUnsafe(2);
                        b.writeUInt16BE(v, 0);
                        return b;
                },
                decoder: function(v, p) {
        ...
        '_nsName': {
                encoder: function(v) {
                        ...
                        var b = new Buffer.allocUnsafe(n.toString().length + 2);
                        var o = 0; //offset
        ...
        '_nsText': {
                encoder: function(v) {
                        var b;
                        b = new Buffer.allocUnsafe(v.length + 1);
...
function encode(obj, format) {
        ...
        result = new Buffer.allocUnsafe(size);
